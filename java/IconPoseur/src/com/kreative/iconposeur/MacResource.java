...
public class MacResource {
	...
	public MacResource(String type, int id, int attr, String name, byte[] data, int off, int len) {
		this(MacResourceType.toInteger(type), id, attr, name, data, off, len);
	}
	
	public MacResource(int type, int id, int attr, String name, byte[] data, int off, int len) {
		this(type, MacResourceType.toString(type));
		this.id = id;
	...
	MacResource(int type, String typeString) {
		this.type = type;
