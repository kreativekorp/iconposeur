...
import com.kreative.ual.UniversalApplicationListener;

public class MyApplicationListener extends UniversalApplicationListener {
	public MyApplicationListener() {
		this.setOpenFilesHandler(new OpenFilesHandler() {
			@Override
		...
		this.setPrintFilesHandler(new PrintFilesHandler() {
			@Override
